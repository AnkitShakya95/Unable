...
auth_users = [1226915008,7341059064]
...
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="📞 Contact", url="https://t.me/AnkitShakya"),
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/AnkitShakya"),
        ],
    ]
)
...
async def txt_handler(bot: Client, m: Message):
            ...
            try:  
                ...
                if "drive" in url:
                    ...
                    Show = f"<pre><code>**⚡𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 𝐒𝐭𝐚𝐫𝐭𝐞𝐝...⏳**</code></pre>\n" \
                           ...
                           f"<pre><code>🔗𝐑𝐞𝐦𝐚𝐢𝐧𝐢𝐧𝐠 𝐋𝐢𝐧𝐤𝐬 » {remaining_links}</code></pre>\n" \
                           f"📝𝐓𝐢𝐭𝐥𝐞 » `{name}`\n" \
    ...
    await m.reply_text("<pre><code>Downloaded By ⌈✨『𝐀𝐧𝐤𝐢𝐭 𝐒𝐡𝐚𝐤𝐲𝐚🇮🇳 』✨⌋</code></pre>")
...
async def text_handler(bot: Client, m: Message):
    ...
    await editable.edit("<pre><code>⚪Send Thumb Or ☞ `no` for **video** format</code></pre>\n<pre><code>🔘Send Thumb or ☞ `no` for **Document** format</code></pre>")
